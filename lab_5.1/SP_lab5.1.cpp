...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        romb = CreateWindow(L"button", L"Rhombus", WS_CHILD |
            WS_VISIBLE | BS_AUTORADIOBUTTON | BS_LEFTTEXT |
            WS_GROUP | WS_TABSTOP,
            100, 140, 70, 30, hWnd, NULL, hInst, NULL);
        kvadrat = CreateWindow(L"button", L"Square", WS_CHILD |
            WS_VISIBLE | BS_AUTORADIOBUTTON | BS_LEFTTEXT,
            200, 140, 70, 30, hWnd, NULL, hInst, NULL);
        krug = CreateWindow(L"button", L"Circle", WS_CHILD |
            WS_VISIBLE | BS_AUTORADIOBUTTON | BS_LEFTTEXT,
            300, 140, 70, 30, hWnd, NULL, hInst, NULL);
        pi3da = CreateWindow(L"button", L"Star", WS_CHILD |
            WS_VISIBLE | BS_AUTORADIOBUTTON | BS_LEFTTEXT,
